      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-2xl p-6 border-2 border-pink-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 font-semibold">Access and download study resources</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-12 text-center">
            ...
            <p className="text-xl font-bold text-gray-900 mb-2">Study Materials</p>
            <p className="text-gray-600">Downloadable resources will be available here</p>
          </div>
        </div>
      </DashboardLayout>
    </ProtectedRoute>
